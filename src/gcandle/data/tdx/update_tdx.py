...
def fetch_and_update_by_tdx():
    ...
    dataService.update_bars(typ=SeType.Index, freq=SeFreq.DAY, days_to_update=1000)
    dataService.update_bars(typ=SeType.Stock, freq=SeFreq.DAY, days_to_update=1000)
